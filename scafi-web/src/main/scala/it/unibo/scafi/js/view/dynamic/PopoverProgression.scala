...
object PopoverProgression {
  ...
  trait Builder {
    /** Add a step popover.
      ...
      * @param title
      *   the title of the popover modal
      * @param text
      *   the body of the popover modal
      * @param direction
  ...
  object Builder {
    ...
    sealed private class PopoverProgressionBuilder extends Builder {
      private val popoverTour: PopoverTour = PopoverTour(Seq.empty)

      /** @inheritdoc */
      override def addNextPopover(
          attachTo: String,
          title: String,
          text: String,
          direction: Direction = Popover.Bottom
      ): Builder = {
        ...
        popoverTour.popovers = popoverTour.popovers :+ Popover(
          attachTo,
          data = div(
            p(text),
    ...
    sealed private case class PopoverTour(var popovers: Seq[Popover]) extends PopoverProgression {
