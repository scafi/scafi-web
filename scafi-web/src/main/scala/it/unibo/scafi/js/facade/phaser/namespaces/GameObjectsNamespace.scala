...
object GameObjectsNamespace extends js.Object {
  ...
  trait GameObject extends Events.EventEmitter with This {
    ...
    def setInteractive(
        shape: types.input.InputConfiguration | js.Any = js.native,
        callback: js.Function4[js.Any, JSNumber, JSNumber, GameObject, Unit] = js.native,
        dropZone: Boolean = js.native
    ): Unit = js.native
  ...
  trait Container
    ...
    def pointToContainer(
        source: Geom.Point | Math.Vector2,
        output: Geom.Point | Math.Vector2 = js.native
    ...
    def getAll(
        property: String = js.native,
        value: js.Any = js.native,
        startIndex: Int = js.native,
        endIndex: Int = js.native
    ...
    def removeBetween(startIndex: Int = js.native, endIndex: Int = js.native, destroyChild: Boolean = js.native): Unit =
      js.native
  ...
  trait GameObjectFactory extends js.Object {
    ...
    def circle(
        x: JSNumber = js.native,
        y: JSNumber,
        radius: JSNumber,
        fillColor: Int = js.native,
        fillAlpha: JSNumber = js.native
    ): Arc = js.native
    ...
    def line(
        ...
        y2: JSNumber = js.native,
        strokeColor: Int = js.native,
        strokeAlpha: JSNumber = js.native
    ): Line = js.native
    def rectangle(
        x: JSNumber = js.native,
        y: JSNumber,
    ...
    def dom(
        ...
        innerText: String = js.native
    ): DOMElement = js.native
    def bitmapText(x: JSNumber, y: JSNumber, font: String, text: String, size: JSNumber = js.native): BitmapText =
      js.native
    def text(x: JSNumber, y: JSNumber, text: String, style: types.gameobjects.text.TextStyle = js.native): Text =
      js.native
    def container(
        x: JSNumber = js.native,
        y: JSNumber = js.native,
        children: js.Array[GameObject] = js.native
    ): Container
  }
