...
//TODO add environment concept? What is it? It is Any? has some constraint?
...
object Graph {
  implicit def tupleToVertex(tuple: (String, String)): Vertex =
    Vertex(tuple._1, tuple._2)
...
case class Node(id: String,
                position: Point3D,
                labels: Map[String, Any] = Map.empty) {
