...
/** A very minimalistic event bus used to intercommunication between dynamic section part. It uses Monix subject to
  * create this event bus. It is like actor in akka platform.
  */
@JSExportAll
class EventBus {
  ...
  /** A functional way to manage events emits by some source
    *
    * @param handler
    *   the handler called for each event
    * @return
    *   the cancellable future that can be used to stop listen aciton
    */
  ...
  /** Publish an event on the event bus
    ...
    *   the event published
    * @return
    *   a Future that is completed when the publish is done
    */
