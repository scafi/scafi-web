...
function storeWorkspace() {
    xmlResult = Blockly.serialization.workspaces.save(Blockly.getMainWorkspace());
    console.log("store")
    window.scafiBlocklyStore = xmlResult;
}

function loadWorkspace() {
    console.log("load")
    Blockly.serialization.workspaces.load(window.scafiBlocklyStore, Blockly.getMainWorkspace());
}
